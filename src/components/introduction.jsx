                                        ...
                                        <div className="col-md-6 col-md-offset-3 col-md-pull-3 col-sm-12 col-xs-12 js-fullheight slider-text">
                                            <div className="slider-text-inner js-fullheight">
                                                <div className="desc">
                                                    ...
                                                    <p><a class="btn btn-primary btn-learn" href="https://1drv.ms/w/c/83006cb728ddd5f0/IQDKiSEDuENZSKLoYvzVrG_LAc75MtbfpHEq7weovjGDOFw?e=YFxoue" download>Download Resume</a></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
